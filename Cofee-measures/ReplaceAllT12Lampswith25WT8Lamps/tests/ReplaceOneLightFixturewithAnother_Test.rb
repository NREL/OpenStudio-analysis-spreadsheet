...
class ReplaceOneLigthtFixturewithAnother_Test < Test::Unit::TestCase

  
  def test_ReplaceOneLigthtFixturewithAnother
     
    # create an instance of the measure
    measure = ReplaceOneLigthtFixturewithAnother.new
