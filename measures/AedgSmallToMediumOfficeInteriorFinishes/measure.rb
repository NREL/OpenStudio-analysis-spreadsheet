...
#start the measure
class AedgSmallToMediumOfficeInteriorFinishes < OpenStudio::Ruleset::ModelUserScript
  ...
  def arguments(model)
    ...
    lowerPartitions = OpenStudio::Ruleset::OSArgument::makeBoolArgument("lowerPartitions",true)
