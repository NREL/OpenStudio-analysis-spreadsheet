...
class SetMaximumReheatAirTemperatureofVAVSingleDuctAirTerminalswithReheat_Test < Test::Unit::TestCase

  
  def test_SetMaximumReheatAirTemperatureofVAVSingleDuctAirTerminalswithReheat
     
    # create an instance of the measure
    measure = SetMaximumReheatAirTemperatureofVAVSingleDuctAirTerminalswithReheat.new
