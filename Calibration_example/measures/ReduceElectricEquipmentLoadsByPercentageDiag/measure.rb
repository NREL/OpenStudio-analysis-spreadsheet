#start the measure
class ReduceElectricEquipmentLoadsByPercentageDiag < OpenStudio::Ruleset::ModelUserScript
...
ReduceElectricEquipmentLoadsByPercentageDiag.new.registerWithApplication