module OsLib_Schedules
  ...
  # find the maximum profile value for a schedule
  def OsLib_Schedules.simpleScheduleValueAdjust(model,schedule,double, modificationType = "Percentage")# can increase/decrease by percentage or static value
  ...
  def OsLib_Schedules.weightedMergeScheduleRulesets(model, scheduleWeighHash)
    ...
    # WARNING - this doesn't do anything with rules yet, just winter, summer, and default profile
