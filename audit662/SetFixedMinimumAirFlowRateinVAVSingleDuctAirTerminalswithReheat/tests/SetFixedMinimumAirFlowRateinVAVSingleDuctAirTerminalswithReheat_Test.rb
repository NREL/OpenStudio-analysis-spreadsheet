...
class SetFixedMinimumAirFlowRateinVAVSingleDuctAirTerminalswithReheat_Test < Test::Unit::TestCase

  
  def test_SetFixedMinimumAirFlowRateinVAVSingleDuctAirTerminalswithReheat
     
    # create an instance of the measure
    measure = SetFixedMinimumAirFlowRateinVAVSingleDuctAirTerminalswithReheat.new
