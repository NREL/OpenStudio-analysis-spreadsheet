...
class SetConstantVolumeFanStaticPressure_Test < Test::Unit::TestCase

  
  def test_SetConstantVolumeFanStaticPressure
     
    # create an instance of the measure
    measure = SetConstantVolumeFanStaticPressure.new
