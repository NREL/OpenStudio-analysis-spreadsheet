...
class SetCOPforSingleSpeedDXCoolingUnits_Test < Test::Unit::TestCase
  
  def test_SetCOPforSingleSpeedDXCoolingUnits_single_loop
     
    # create an instance of the measure
    measure = SetCOPforSingleSpeedDXCoolingUnits.new
    ...
    assert_equal("cop", arguments[count += 1].name)
    ...
    cop = arguments[count += 1].clone
    assert(cop.setValue(2.0))
    argument_map["cop"] = cop
  ...
  def test_SetCOPforSingleSpeedDXCoolingUnits_all_loop
