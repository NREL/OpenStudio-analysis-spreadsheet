...
# start the measure
class TariffSelectionBlock < OpenStudio::Ruleset::WorkspaceUserScript
  ...
  def arguments(workspace)
    ...
    elec_block_values = OpenStudio::Ruleset::OSArgument.makeStringArgument("elec_block_values", true)
    ...
    # adding argument for elec_rate
    elec_block_costs = OpenStudio::Ruleset::OSArgument.makeStringArgument("elec_block_costs", true)
    ...
    # adding argument for elec_rate
    elec_remaining_rate = OpenStudio::Ruleset::OSArgument.makeDoubleArgument("elec_remaining_rate", true)
