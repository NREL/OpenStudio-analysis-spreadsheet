...
for(i in 1:nrow(data_for_analysis)){
  ...
  save(results,paste(wd_base,toString(data_for_analysis[i,"metadata_dataframe"]),sep="/"))
}
...
for(i in 1:nrow(data_for_analysis)){
  ...
  save(results,paste(wd_base,toString(data_for_analysis[i,"results_dataframe"]),sep="/"))
}