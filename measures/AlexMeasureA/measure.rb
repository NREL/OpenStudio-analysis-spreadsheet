...
# start the measure
class AlexMeasureA < OpenStudio::Ruleset::ModelUserScript

  # human readable name
  def name
    return "Alex Measure A"
  end

  # human readable description
  def description
    return "Basic measure for testing"
  end

  # human readable description of modeling approach
  def modeler_description
    return "Testing only; do not use."
  end
...
AlexMeasureA.new.registerWithApplication
