...
class ChangeRoofThermalPropertiesByPercentage_Test  < MiniTest::Test

  def test_ChangeRoofThermalPropertiesByPercentage

    # create an instance of the measure
    measure = ChangeRoofThermalPropertiesByPercentage.new
    ...
    surface_array.each do |surface|
      if surface.outsideBoundaryCondition == "Outdoors" and surface.surfaceType == "RoofCeiling"
        roof_surface_array << surface
        roof_surface_const = surface.construction.get
        unless construction_array.include?(roof_surface_const)
          construction_array << roof_surface_const.to_Construction.get
        end
      end
    end
